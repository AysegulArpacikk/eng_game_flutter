...
Widget pairingWordPage(PairingWordPageBloc bloc, List<dynamic> pairingWordList) => Material(
    child: MultiBlocProvider(
      providers: [
        BlocProvider.value(
            value: bloc
              ..add(PairingWordPageInitializeEvent(pairingWordList: pairingWordList)))
      ],
